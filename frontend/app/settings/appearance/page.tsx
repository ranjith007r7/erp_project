  ...
  return (
    <main className="min-h-screen p-8">
      ...
      <div className="space-y-6 max-w-2xl">
        ...
        <Card className="p-4">
          <h2 className="font-semibold text-slate-700 dark:text-slate-200 text-sm mb-1">Theme</h2>
        ...
        <Card className="p-4">
          <h2 className="font-semibold text-slate-700 dark:text-slate-200 text-sm mb-1 flex items-center gap-1.5">
